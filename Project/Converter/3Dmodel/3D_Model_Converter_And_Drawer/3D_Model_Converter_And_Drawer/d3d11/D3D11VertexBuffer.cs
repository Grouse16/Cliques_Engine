...
namespace SharpDXSample
{
    public struct Vertex
    {
        ...
        public float NX { get { return Normal.X; } }
        public float NY { get { return Normal.Y; } }
        public float NZ { get { return Normal.Z; } }
        public float NW { get { return Normal.W; } }

        public Vertex(Vector4 pos, Vector4 col, Vector4 nom)
        {
            Position = pos;
            Color = col;
            Normal = nom;
        ...
        {
            return $"({Position.X}, {Position.Y}, {Position.Z})({Color.X}, {Color.Y}, {Color.Z}, {Color.W})({Normal.X}, {Normal.Y}, {Normal.Z}, {Normal.W})";
        }
    }
