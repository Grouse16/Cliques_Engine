...
namespace RENDERING::API::DX12::DX12_TOOL
{
	...
	private:
		...
		static DXGI_FORMAT M_Get_Write_Rendering_Graph_Format_By_Create_Inform(const RENDERING::API::CREATE::S_Blend_Setting_Create_Data & );
	...
	public:
		...
		static void M_Set_Blend_State_By_Inform(D3D12_GRAPHICS_PIPELINE_STATE_DESC & , const RENDERING::API::CREATE::S_Create_Rendering_Graphics_Setting_Inform & );
	};
}
