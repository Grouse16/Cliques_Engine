...
// ☆ 多重インクルードガード ☆ //
#ifndef D_INCLUDE_GUARD_E_DEPTH_STENCIL_BUFFER_PIXEL_SIZE
#define D_INCLUDE_GUARD_E_DEPTH_STENCIL_BUFFER_PIXEL_SIZE
...
#endif // !D_INCLUDE_GUARD_E_DEPTH_STENCIL_BUFFER_PIXEL_SIZE
