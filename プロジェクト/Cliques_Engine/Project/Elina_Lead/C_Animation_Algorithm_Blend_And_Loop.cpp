...
// 戻り値 ：void
//☆=☆=☆=☆=☆=☆=☆=☆=☆=☆=☆=☆=☆=☆=☆=☆//
void C_Animation_Algorithm_Blend_And_Loop::M_Animation_Update(std::vector<DirectX::XMFLOAT4X4> & out_set_matrix, const std::vector<ASSET::ANIMATION::BONE::S_Bone_Inform> & in_offset_matrix_list)
{
	// ☆ 変数宣言 ☆ //
	...
	m_to_animation->M_Create_Bone_Matrix_List(out_set_matrix, bone_data_list, in_offset_matrix_list);
