...
{
	return RENDERING::API::RENDER_INTERFACE::C_Rendering_API_Interface_Rendering_Setting::M_Create_Rendering_Setting(out_result_rendering_setting, in_create_inform);
}
...
{
	RENDERING::API::RENDER_INTERFACE::C_Rendering_API_Interface_Rendering_Setting::M_Set_Rendering_Setting_To_Draw(in_set_rendering_setting);
